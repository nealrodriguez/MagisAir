...
class BookingAdditionalitem(models.Model):
    ...
    bai_flight = models.ForeignKey(Booking, models.DO_NOTHING)
...
class Flight(models.Model):
    ...
    flt_route = models.ForeignKey('Route', models.DO_NOTHING)
...
class Route(models.Model):
    ...
    rt_origin = models.ForeignKey(Location, models.DO_NOTHING, db_column='rt_origin')
